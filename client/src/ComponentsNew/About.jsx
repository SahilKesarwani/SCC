...
export default function About() {
  ...
  useEffect(()=>{
    ...
    particularEventSection1div1.addEventListener('click',()=>{
        particularEventSection1div1WidthHold=(particularEventSection1div1WidthHold==0)?1:0;
    })
    window.addEventListener("mousemove", (mouse) => {
        if(particularEventSection1div1WidthHold==0){
      particularEventSection1div1.style.width = window.innerWidth - mouse.x + "px";}
    });
      ...
      <div className="particularEventSection1div1">
        <div className="particularEventSection1div1heading">
          <div className="particularEventSection1div1headingText">
            ...
            <svg
              style={{height: "1.7em", position: "relative", bottom: "-47px"}}
              viewBox="0 0 310 199"
              fill="none"
    ...
    <div className="secondSec">
      <div className="aboutSCCIntroContainer">
        <div className="aboutSCCIntroContainerText">
          ...
          field. We are a team of students of SIET, striving towards growth, and
          success by excelling in the field of Computer Science.
        </div>
    ...
    <div className="fourth">
      <div className="eCard">
        <div className="eventImg">
          <img
            src="https://tse4.mm.bing.net/th?id=OIP.XM6Bt1eudAsRjY610zeemgHaEK&pid=Api&P=0&h=180"
          />
        </div>
